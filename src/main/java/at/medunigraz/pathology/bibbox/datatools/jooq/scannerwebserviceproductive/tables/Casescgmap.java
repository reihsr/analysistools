...
import at.medunigraz.pathology.bibbox.datatools.jooq.scannerwebserviceproductive.tables.records.CasescgmapRecord;
...
public class Casescgmap extends TableImpl<CasescgmapRecord> {
    ...
    private static final long serialVersionUID = -1779501730;

    /**
     * The reference instance of <code>scannerwebserviceproductive.casescgmap</code>
     */
    ...
    /**
     * The column <code>scannerwebserviceproductive.casescgmap.vhistonumberid_fk</code>.
     */
    ...
    /**
     * The column <code>scannerwebserviceproductive.casescgmap.scgid_fk</code>.
     */
    public final TableField<CasescgmapRecord, String> SCGID_FK = createField("scgid_fk", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * Create a <code>scannerwebserviceproductive.casescgmap</code> table reference
     */
    public Casescgmap() {
    ...
    /**
     * Create an aliased <code>scannerwebserviceproductive.casescgmap</code> table reference
     */
