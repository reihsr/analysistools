...
/**
 * A class modelling indexes of tables of the <code>xxxold_scannerwebserviceproductive</code> 
 * schema.
 */
@Generated(
    value = {
...
public class Indexes {
    ...
    public static final Index PKTMP = Indexes0.PKTMP;
    ...
    private static class Indexes0 {
        public static Index PKTMP = Internal.createIndex("PKTMP", Casetable.CASETABLE, new OrderField[] { Casetable.CASETABLE.TMPID }, true);
