...
import at.medunigraz.pathology.bibbox.datatools.jooq.scannerwebserviceproductive.tables.records.CaseicdomapRecord;
...
public class Caseicdomap extends TableImpl<CaseicdomapRecord> {
    ...
    private static final long serialVersionUID = -2012758569;

    /**
     * The reference instance of <code>scannerwebserviceproductive.caseicdomap</code>
     */
    ...
    /**
     * The column <code>scannerwebserviceproductive.caseicdomap.vhistonumberid_fk</code>.
     */
    ...
    /**
     * The column <code>scannerwebserviceproductive.caseicdomap.icdoid_fk</code>.
     */
    public final TableField<CaseicdomapRecord, Integer> ICDOID_FK = createField("icdoid_fk", org.jooq.impl.SQLDataType.INTEGER, this, "");

    /**
     * Create a <code>scannerwebserviceproductive.caseicdomap</code> table reference
     */
    public Caseicdomap() {
    ...
    /**
     * Create an aliased <code>scannerwebserviceproductive.caseicdomap</code> table reference
     */
