...
import at.medunigraz.pathology.bibbox.datatools.jooq.xxxold_scannerwebserviceproductive.tables.records.InboxtableRecord;
...
public class Inboxtable extends TableImpl<InboxtableRecord> {
    ...
    private static final long serialVersionUID = 1866973235;

    /**
     * The reference instance of <code>xxxold_scannerwebserviceproductive.inboxtable</code>
     */
    ...
    /**
     * The column <code>xxxold_scannerwebserviceproductive.inboxtable.inboxid</code>.
     */
    public final TableField<InboxtableRecord, Integer> INBOXID = createField("inboxid", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>xxxold_scannerwebserviceproductive.inboxtable.inboxfolder</code>.
     */
    public final TableField<InboxtableRecord, String> INBOXFOLDER = createField("inboxfolder", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>xxxold_scannerwebserviceproductive.inboxtable.inboxisactive</code>.
     */
    ...
    /**
     * The column <code>xxxold_scannerwebserviceproductive.inboxtable.inboxinfo</code>.
     */
    public final TableField<InboxtableRecord, String> INBOXINFO = createField("inboxinfo", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>xxxold_scannerwebserviceproductive.inboxtable.inboxthreads</code>.
     */
    ...
    /**
     * Create a <code>xxxold_scannerwebserviceproductive.inboxtable</code> table reference
     */
    public Inboxtable() {
    ...
    /**
     * Create an aliased <code>xxxold_scannerwebserviceproductive.inboxtable</code> table reference
     */
