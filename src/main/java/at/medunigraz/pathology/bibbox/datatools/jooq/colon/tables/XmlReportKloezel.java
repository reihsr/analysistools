...
public class XmlReportKloezel extends TableImpl<XmlReportKloezelRecord> {
    ...
    private static final long serialVersionUID = 1282190947;

    /**
     * The reference instance of <code>colon.xml_report_kloezel</code>
     */
    ...
    /**
     * The column <code>colon.xml_report_kloezel.id</code>.
     */
    public final TableField<XmlReportKloezelRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('colon.xml_report_kloezel_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>colon.xml_report_kloezel.BEFUNDLFDNR1</code>.
     */
    ...
    /**
     * The column <code>colon.xml_report_kloezel.STUECKANZAHL1</code>.
     */
    ...
    /**
     * The column <code>colon.xml_report_kloezel.STATUS1</code>.
     */
    ...
    /**
     * The column <code>colon.xml_report_kloezel.ORGEINHEIT1</code>.
     */
    ...
    /**
     * Create an aliased <code>colon.xml_report_kloezel</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.COLON_XML_REPORT_KLOEZEL_ID_PKEY);
    }
    ...
    public UniqueKey<XmlReportKloezelRecord> getPrimaryKey() {
        return Keys.COLON_XML_REPORT_KLOEZEL_ID_PKEY;
    }
    ...
    public List<UniqueKey<XmlReportKloezelRecord>> getKeys() {
        return Arrays.<UniqueKey<XmlReportKloezelRecord>>asList(Keys.COLON_XML_REPORT_KLOEZEL_ID_PKEY);
    }
