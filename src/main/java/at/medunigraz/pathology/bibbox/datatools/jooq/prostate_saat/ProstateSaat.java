...
public class ProstateSaat extends SchemaImpl {
    ...
    private static final long serialVersionUID = -1338211140;
     ...
     */
    public final ExtractedGleason EXTRACTED_GLEASON = at.medunigraz.pathology.bibbox.datatools.jooq.prostate_saat.tables.ExtractedGleason.EXTRACTED_GLEASON;
    ...
    private final List<Sequence<?>> getSequences0() {
        return Arrays.<Sequence<?>>asList(
            Sequences.EXTRACTED_GLEASON_EXTRACTED_GLEASON_ID_SEQ,
    ...
    private final List<Table<?>> getTables0() {
        return Arrays.<Table<?>>asList(
            ...
            ExtractedGleason.EXTRACTED_GLEASON,
