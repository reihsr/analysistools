...
/**
 * A class modelling indexes of tables of the <code>scannerwebserviceproductive</code> 
 * schema.
 */
@Generated(
    value = {
...
public class Indexes {
    ...
    public static final Index IDMAPTABLE_PKEY = Indexes0.IDMAPTABLE_PKEY;
    public static final Index INBOXTABLE_PKEY = Indexes0.INBOXTABLE_PKEY;
    public static final Index KEYVALUETABLE_PKEY = Indexes0.KEYVALUETABLE_PKEY;
    public static final Index PROJECTKEYVALUEMAP_PKEY = Indexes0.PROJECTKEYVALUEMAP_PKEY;
    ...
    public static final Index TYPETABLE_PKEY = Indexes0.TYPETABLE_PKEY;
    ...
    private static class Indexes0 {
        ...
        public static Index IDMAPTABLE_PKEY = Internal.createIndex("idmaptable_pkey", Idmaptable.IDMAPTABLE, new OrderField[] { Idmaptable.IDMAPTABLE.INTERNALID, Idmaptable.IDMAPTABLE.EXTERNALID, Idmaptable.IDMAPTABLE.PROJECTID }, true);
        ...
        public static Index KEYVALUETABLE_PKEY = Internal.createIndex("keyvaluetable_pkey", Keyvaluetable.KEYVALUETABLE, new OrderField[] { Keyvaluetable.KEYVALUETABLE.KEYVALUEID }, true);
        public static Index PROJECTKEYVALUEMAP_PKEY = Internal.createIndex("projectkeyvaluemap_pkey", Projectkeyvaluemap.PROJECTKEYVALUEMAP, new OrderField[] { Projectkeyvaluemap.PROJECTKEYVALUEMAP.PROJECTID_FK, Projectkeyvaluemap.PROJECTKEYVALUEMAP.KEYVALUEID_FK }, true);
        ...
        public static Index TYPETABLE_PKEY = Internal.createIndex("typetable_pkey", Typetable.TYPETABLE, new OrderField[] { Typetable.TYPETABLE.TYPEID }, true);
