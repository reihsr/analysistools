...
public class XlsxStatistikAustria extends TableImpl<XlsxStatistikAustriaRecord> {
    ...
    private static final long serialVersionUID = 163472963;

    /**
     * The reference instance of <code>prostate.xlsx_statistik_austria</code>
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.id</code>.
     */
    public final TableField<XlsxStatistikAustriaRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('prostate.xlsx_statistik_austria_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>prostate.xlsx_statistik_austria.vpatid</code>.
     */
    public final TableField<XlsxStatistikAustriaRecord, Long> VPATID = createField("vpatid", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>prostate.xlsx_statistik_austria.vhistid</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.gender</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.dod</code>.
     */
    public final TableField<XlsxStatistikAustriaRecord, String> DOD = createField("dod", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>prostate.xlsx_statistik_austria.icdncode</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.icdecode</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.survival_atum_erstprobe_bis_sterbedatum</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.survival_datum_erstprobe_bis_heute</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.alter_pat_heute</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.heute</code>.
     */
    public final TableField<XlsxStatistikAustriaRecord, String> HEUTE = createField("heute", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>prostate.xlsx_statistik_austria.datum_erstprobe</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.file</code>.
     */
    public final TableField<XlsxStatistikAustriaRecord, String> FILE = createField("file", org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>prostate.xlsx_statistik_austria.vpatid_extended</code>.
     */
    ...
    /**
     * The column <code>prostate.xlsx_statistik_austria.vhistid_extended</code>.
     */
    ...
    /**
     * Create a <code>prostate.xlsx_statistik_austria</code> table reference
     */
    ...
    /**
     * Create an aliased <code>prostate.xlsx_statistik_austria</code> table reference
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PROSTATE_XLSX_STATISTIK_AUSTRIA_PKEY);
    }
    ...
    public UniqueKey<XlsxStatistikAustriaRecord> getPrimaryKey() {
        return Keys.PROSTATE_XLSX_STATISTIK_AUSTRIA_PKEY;
    }
    ...
    public List<UniqueKey<XlsxStatistikAustriaRecord>> getKeys() {
        return Arrays.<UniqueKey<XlsxStatistikAustriaRecord>>asList(Keys.PROSTATE_XLSX_STATISTIK_AUSTRIA_PKEY);
    }
